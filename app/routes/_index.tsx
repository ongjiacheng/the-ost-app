...
export default function Home() {
    return (
        <Box sx={{ minHeight: "70vh", py: 5, textAlign: "center" }}>
            <Typography variant="h3" sx={{py: 4}}>
                This is One Stop Transport
            </Typography>
            ...
            <Stack direction="row" sx={{ justifyContent: "center", py: 2 }}>
                <IconButton component="a" href="https://tinyurl.com/osthyperlapse"><YouTubeIcon /></IconButton>
