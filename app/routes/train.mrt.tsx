...
import stations from "../assets/mrt_stations.json";
...
export default function MRT() {
    return (
        <Container>
            <Typography variant="h2">MRT Stations</Typography>
            {stations.map(line => (
                <Container>
                    <Typography variant="h4">{line.line}</Typography>
                    <MRTTable line={line.stations} />
                </Container>
            ))
            }
        </Container>
...
function MRTTable(props: { line: TrainStationType[] }) {
    return (
        <Container>
            <Table>
                <TableHead>
